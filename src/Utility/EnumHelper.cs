...
namespace Utility
{
    ...
    public class EnumHelper
    {
        ...
        public static int GetNotiTypeMatch(Enum e, Enum language = null)
        {
            if (e == null)
            {
                return -1;
            ...
            if (name != null)
            {
                ...
                {
                    // 获取描述的属性。
                    NotiTypeMatchAttribute attr = Attribute.GetCustomAttribute(fieldInfo, typeof(NotiTypeMatchAttribute), false) as NotiTypeMatchAttribute;
                    if (attr != null)
                    {
                        return attr.notiType;
                    }
                }
            }
            return -1;
    ...
    public class NotiTypeMatchAttribute : Attribute
    {
        public int notiType { get; set; }

        public NotiTypeMatchAttribute(int type)
        {
